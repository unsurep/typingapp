    ...
    return (
        <div className="flex flex-col flex-1 w-full max-w-4xl mx-auto py-12 px-4 sm:px-6 relative">
            ...
            <section className="mt-20 max-w-3xl mx-auto w-full">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t("seo.howItWorksTitle")}</h2>
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-8">{t("seo.howToUseTitle")}</h2>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                    {t("seo.howToUseP1")}
                </p>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-8">{t("seo.goodSpeedTitle")}</h2>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                    {t("seo.goodSpeedP1")}
                </p>
